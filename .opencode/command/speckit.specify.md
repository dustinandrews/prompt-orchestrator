...
The text the user typed after `/speckit.specify` in the triggering message or any attached file **is** the feature description. Assume you always have it available in this conversation even if `$ARGUMENTS` appears literally below. Do not ask the user to repeat it unless they provided an empty command.
